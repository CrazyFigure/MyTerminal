...
export interface McpIconProps extends SVGProps<SVGSVGElement> {
  /** 图标像素尺寸，默认为 16 */
  size?: number | string;
  /** 描边粗细，默认为 14（在 180x180 坐标系下，相当于 24px 栅格下的 1.87px） */
  strokeWidth?: number | string;
}

/**
 * Model Context Protocol (MCP) 官方标准矢量标志组件。
 * 采用官方双联锁莫比乌斯环结构，与 Lucide 图标的 currentColor 与圆角端点保持一致规范。
 */
